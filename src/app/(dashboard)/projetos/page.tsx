    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-600 mt-1">Gestão de projetos e entregas</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="shadow-sm">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500">53% do total</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500">35% do total</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500">12% do total</p>
            </CardContent>
          </Card>
        </div>
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                ...
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-500">Entrega em 15 dias</p>
                  </div>
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                ...
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-500">Entrega em 30 dias</p>
                  </div>
                  <Badge variant="secondary" className="text-xs">Em Andamento</Badge>
                </div>
              </div>
