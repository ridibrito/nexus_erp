  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-6">
        <div className="mb-8">
          <h1 className="text-xl font-semibold text-gray-900">Movimentações Bancárias</h1>
          <p className="text-sm text-gray-600 mt-1">A conexão com o banco - interface com o dinheiro real</p>
        </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm">Recebimento Cliente ABC</p>
                    <p className="text-xs text-gray-500">15/01/2024 - 14:30</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium text-green-600">+R$ 5.200,00</p>
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm">Pagamento Fornecedor XYZ</p>
                    <p className="text-xs text-gray-500">15/01/2024 - 10:15</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium text-red-600">-R$ 2.500,00</p>
                  <p className="text-xs text-gray-500">Itaú</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm">Transferência Interna</p>
                    <p className="text-xs text-gray-500">14/01/2024 - 16:45</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium text-blue-600">R$ 3.000,00</p>
                  <p className="text-xs text-gray-500">BB → Itaú</p>
                </div>
              </div>
            </div>
          </CardContent>
