-- SIMPLIFICAR ESTRUTURA: Remover workspace desnecessário
-- Um workspace tem apenas uma empresa = desnecessário!

-- 1. CRIAR NOVA ESTRUTURA SIMPLIFICADA
...
-- 3. ATUALIZAR REFERÊNCIAS NAS OUTRAS TABELAS
